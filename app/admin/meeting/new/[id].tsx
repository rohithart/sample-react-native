...
export default function AddMeetingScreen() {
  ...
  const handleSubmit = async () => {
    ...
    showToast({ type: 'success', title: 'Success', message: 'Meeting created successfully' });
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      >
        ...
        <SubmitButton onPress={handleSubmit} isSubmitting={isSubmitting} label="Create Meeting" />
      </ScrollView>
    </SafeAreaView>
  );
}
