...
export default function GroupDetailScreen() {
  ...
  const { data: item, isLoading: isLoadingItem, refetch, isRefetching } = useGroup(id || '');
  ...
  const handleDelete = async () => {
    ...
    showToast({ type: 'success', title: 'Success', message: 'Group deleted successfully' });
    router.push(`/admin/groups/${orgId}`);
  };
  ...
  const handleArchive = async () => {
    ...
    setIsProcessing(false);
    setConfirmationType(null);
    showToast({ type: 'success', title: 'Success', message: 'Group archived successfully' });
  };
  ...
  const actions: ActionItem[] = [
    ...(isAdmin ? [{
      ...
      onPress: () => router.push(`/admin/group/${orgId}/${id}/edit`),
