...
export default function EditChartofAccountScreen() {
  ...
  const handleSubmit = async () => {
    ...
    Alert.alert('Success', 'Chart of Account updated successfully', [
      { text: 'OK', onPress: () => router.push(`/admin/coa/${orgId}/${id}`) },
    ]);
  };
  ...
  const handleDelete = () => {
    Alert.alert(
      ...
      'This action cannot be reversed. The chart of account will be permanently deleted.',
      [
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <PageHeader title="Edit Chart of Account" />
