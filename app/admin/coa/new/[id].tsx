...
export default function AddChartofAccountScreen() {
  ...
  const handleSubmit = async () => {
    ...
    showToast({ type: 'success', title: 'Chart of Account created successfully' });
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      >
        ...
        <SubmitButton onPress={handleSubmit} isSubmitting={isSubmitting} label="Create Chart of Account" />
      </ScrollView>
    </SafeAreaView>
  );
}
