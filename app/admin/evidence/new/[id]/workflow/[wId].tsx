...
export default function NewEvidenceFromWorkflowScreen() {
  ...
  const handleSubmit = async () => {
    ...
    showToast({ type: 'success', title: 'Success', message: 'New Evidence created successfully' });
    router.back();
  };
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <PageHeader icon="evidence" title="New Evidence" />
