  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      <View style={{ flexDirection: 'row', alignItems: 'center', padding: 16, borderBottomWidth: 1, borderColor: colors.border, backgroundColor: colors.card }}>
        ...
        <Text style={{ fontSize: 18, fontWeight: '700', color: colors.text }}>Workflow Analytics</Text>
      </View>
      <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center', gap: 8 }}>
        <Text style={{ fontSize: 48 }}>📈</Text>
        <Text style={{ fontSize: 20, fontWeight: '700', color: colors.text }}>Workflow Analytics</Text>
