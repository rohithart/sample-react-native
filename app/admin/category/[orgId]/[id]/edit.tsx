...
export default function EditCategoryScreen() {
  ...
  const [description, setDescription] = useState('This is a sample category description.');
  ...
  const handleSubmit = async () => {
    ...
    Alert.alert('Success', 'Category updated successfully', [
      { text: 'OK', onPress: () => router.push(`/admin/category/${orgId}/${id}`) },
    ]);
  };
  ...
  const handleDelete = () => {
    Alert.alert(
      'Delete Category',
      'This action cannot be reversed. The category will be permanently deleted.',
      [
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <PageHeader icon="category" title="Edit Category" />
