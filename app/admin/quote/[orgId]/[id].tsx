...
import { useQuote, useUpdateQuoteStatus } from '@/services/quote';
...
export default function QuoteDetailScreen() {
  ...
  const actions: ActionItem[] = [
    ...
    { id: 'pdf', label: 'Download PDF', icon: <I.fileDown size={24} color={colors.success} />, onPress: () => downloadAndSharePdf('quote', id || ''), color: 'success' as const },
