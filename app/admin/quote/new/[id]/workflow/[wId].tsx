...
export default function NewQuoteWorkflowScreen() {
  ...
  const handleSubmit = async () => {
    ...
    showToast({ type: 'success', title: 'Success', message: 'New Quote created successfully' });
    router.back();
  };
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <PageHeader icon="quote" title="New Quote" />
