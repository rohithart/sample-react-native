...
export default function TaskDetailScreen() {
  ...
  const actions: ActionItem[] = [
    ...(isAdmin ? [{
      ...
      onPress: () => router.push(`/admin/task/${orgId}/${id}/edit`),
    ...
    { id: 'pdf', label: 'Download PDF', icon: <I.fileDown size={24} color={colors.success} />, onPress: () => downloadAndSharePdf(EntityType.TASK, id || ''), color: 'success' as const },
