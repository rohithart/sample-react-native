...
export default function NewInvoiceFromWorkorderScreen() {
  const { id, woId } = useLocalSearchParams<{ id: string; woId: string }>();
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      >
        <View style={{ backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border, borderRadius: 8, padding: 12 }}>
          <Text style={{ fontSize: 12, color: colors.sub }}>Context: Work Order: ${woId}</Text>
        </View>
