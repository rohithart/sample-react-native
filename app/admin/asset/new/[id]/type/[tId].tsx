...
export default function NewAssetFromTypeScreen() {
  ...
  const handleSubmit = async () => {
    ...
    showToast({ type: 'success', title: 'New Asset created successfully' });
    router.back();
  };
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <PageHeader icon="asset" title="New Asset" />
      ...
      >
        <View style={{ backgroundColor: colors.card, borderWidth: 1, borderColor: colors.border, borderRadius: 8, padding: 12 }}>
          <Text style={{ fontSize: 12, color: colors.sub }}>Context: Asset Type: ${tId}</Text>
        </View>
