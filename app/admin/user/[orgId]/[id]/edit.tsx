...
export default function EditUserScreen() {
  ...
  const [description, setDescription] = useState('This is a sample user description.');
  ...
  const handleSubmit = async () => {
    ...
    showToast({ type: 'success', title: 'Success', message: 'User updated successfully' });
    router.push(`/admin/user/${orgId}/${id}`);
  };

  const handleDelete = () => {
    Alert.alert(
      'Delete User',
      'This action cannot be reversed. The user will be permanently deleted.',
      [
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <PageHeader icon="user" title="Edit User" />
