...
export default function EditVendorScreen() {
  ...
  const [description, setDescription] = useState('This is a sample vendor description.');
  ...
  const handleSubmit = async () => {
    ...
    showToast({ type: 'success', title: 'Success', message: 'Vendor updated successfully' });
    router.push(`/admin/vendor/${orgId}/${id}`);
  };

  const handleDelete = () => {
    Alert.alert(
      'Delete Vendor',
      'This action cannot be reversed. The vendor will be permanently deleted.',
      [
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.bg }}>
      ...
      <PageHeader icon="vendor" title="Edit Vendor" />
